    ...
    >
      ...
      >
        ...
        >
          ...
          {/* Ícone oficial do WhatsApp (balão de conversa com monofone clássico - Simple Icons / Meta brand) */}
          <svg
            viewBox="0 0 24 24"
            className="w-8 h-8 fill-current relative z-10 drop-shadow-sm pointer-events-none select-none"
            aria-hidden="true"
          >
